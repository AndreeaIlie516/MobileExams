...
fun AddEditEntityScreen(
    ...
    val caloriesState = viewModel.entityCalories.value
    val dateState = viewModel.entityDate.value
    val notesState = viewModel.entityNotes.value
    ...
    )
    {
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                OutlinedTextField(
                    value = caloriesState.text,
                    label = { Text("Calories") },
                    onValueChange = {
                        viewModel.onEvent(AddEditEntityEvent.EnteredCalories(it))
                    },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(16.dp)
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Date") },
                    onValueChange = {
                        viewModel.onEvent(AddEditEntityEvent.EnteredDate(it))
                    },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(16.dp)
                ...
                OutlinedTextField(
                    ...
                    label = { Text("Notes") },
                    onValueChange = {
                        viewModel.onEvent(AddEditEntityEvent.EnteredNotes(it))
                    },
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(16.dp)
