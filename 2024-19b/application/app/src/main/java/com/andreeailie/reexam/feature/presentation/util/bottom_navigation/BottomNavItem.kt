...
sealed class BottomNavItem(var title: String, var icon: Int, var screenRoute: String) {
    object HomeScreen : BottomNavItem("Registration", R.drawable.baseline_home_24, "home_screen")
    object SecondScreen : BottomNavItem("Report", R.drawable.baseline_food_bank_24, "second_screen")
