...
constructor(
    ...
    fun fetchEntitiesIfNeeded() {
        Log.d("EntitiesViewModel", "fetchEntitiesIfNeeded called")
        viewModelScope.launch {
    ...
    fun getEntityById(id: Int): Entity? {
        val entity = performServerOperation {
            entityUseCases.getEntityUseCase(id)
        }
        return null
    }
            ...
            is EntitiesEvent.DeleteEntity -> performServerOperation {
                try {
                    ...
                    if (result == "Success") {
                        ...
                        val property = getPropertyByName(event.entity.genre)
                        if(property != null) {
        ...
        viewModelScope.launch {
            try {
                ...
                webSocketClient.events.collect { event ->
                    ...
                    Log.i("EntitiesViewModel", "newEntity: $newEntity")
    ...
    private suspend fun calculateTopEntities() {
        val entities = entityUseCases.getAllEntitiesUseCase().first()
        val sortedEntities = entities.sortedByDescending { it.year }.take(10)
